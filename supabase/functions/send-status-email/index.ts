...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    if (status === 'aprovado') {
      ...
      console.log(`[EMAIL SYSTEM] Mensagem: Parabéns! Sua análise foi aprovada. Clique no link abaixo para completar seu cadastro no sistema. Link válido por 7 dias.`);
      ...
      console.log(`[EMAIL SYSTEM] Mensagem: Infelizmente, sua análise não foi aprovada. Motivo: ${motivo}. Entre em contato conosco para mais informações: contato@seaconnection.com.br`);
    }
